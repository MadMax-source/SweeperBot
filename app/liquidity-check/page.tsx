          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center justify-between mb-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm mt-1">
                Verify liquidity locks and detect potential rug pulls
              </p>
            </div>
                    ...
                    {liquidityPools.map((pool) => (
                      <tr key={pool.id} className="hover:bg-muted/50 transition-colors">
                        ...
                        <td className="p-4">
                          <div className="flex items-center gap-2">
                            <div
                              className={`w-8 h-8 rounded-full flex items-center justify-center ${getTrustScoreBg(pool.trustScore)}/20`}
                            >
                              <span
                                className={`text-sm font-bold ${getTrustScoreColor(pool.trustScore)}`}
                              >
                                {pool.trustScore}
                              </span>
                            </div>
