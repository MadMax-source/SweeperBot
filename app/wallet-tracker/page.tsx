...
const walletAlerts = [
  {
    wallet: 'Suspicious Wallet',
    message: 'Large outflow detected - 18% of holdings moved',
    severity: 'critical',
    time: '5m ago',
  },
  {
    wallet: 'Dev Wallet',
    message: 'First transaction in 30 days',
    severity: 'warning',
    time: '15m ago',
  },
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm mt-1">
                Monitor wallet activities and detect suspicious movements
              </p>
            </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <div className="flex items-center justify-end gap-1 mt-1">
                          ...
                          <span
                            className={
                              wallet.isPositive ? 'text-green-500 text-sm' : 'text-red-500 text-sm'
                            }
                          >
                            {wallet.change24h}
                          </span>
