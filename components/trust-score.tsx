...
export function TrustScore() {
  ...
  return (
    <div className="rounded-xl border border-border bg-card p-5">
      ...
      <div className="mt-2 text-center text-sm font-semibold text-success">LOW RISK</div>
      ...
      <button className="mt-4 w-full rounded-lg border border-border bg-secondary py-2 text-xs font-medium text-muted-foreground hover:text-white transition-colors">
        CLEAR
      </button>
    </div>
  )
