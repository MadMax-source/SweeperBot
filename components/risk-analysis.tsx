      ...
      <div className="flex gap-6">
        ...
        <div className="flex-shrink-0">
          <div className="rounded-lg border border-border bg-secondary/50 p-4">
            ...
            <div className="mt-1 text-xs font-semibold text-[#ff6b00]">LOW RISK</div>
        ...
        <div className="relative flex-1">
          <svg viewBox="0 0 200 200" className="mx-auto h-40 w-40">
            ...
            {radarData.map((item, i) => {
              ...
              return <circle key={item.label} cx={x} cy={y} r="4" fill="#3b82f6" />;
            })}
          </svg>

          {/* Labels */}
          <div className="absolute left-1/2 top-0 -translate-x-1/2 text-[10px] text-muted-foreground">
            Liquidity
            <br />
            <span className="font-semibold text-primary">88</span>
          </div>

          <div className="absolute right-0 top-8 text-right text-[10px] text-muted-foreground">
            Market
            <br />
            <span className="font-semibold text-primary">70</span>
          </div>

          <div className="absolute bottom-8 right-2 text-right text-[10px] text-muted-foreground">
            Team
            <br />
          ...
          <div className="absolute left-0 top-8 text-[10px] text-muted-foreground">
            Security
            <br />
