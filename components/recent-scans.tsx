              ...
              <tr key={index} className="border-t border-border">
                <td className="py-3">
                  <div className="flex items-center gap-2">
                    <div className={`flex h-7 w-7 items-center justify-center rounded-full ${scan.color} text-sm`}>
                      {scan.symbol}
                    </div>
                ...
                <td className="py-3">
                  <span className="text-sm text-muted-foreground font-mono">{scan.address}</span>
                </td>
                <td className="py-3">
                  <div className="flex items-center gap-2">
